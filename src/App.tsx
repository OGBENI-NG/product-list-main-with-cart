...
const App: React.FC = () => {
  ...
  const focusTimeoutRef = useRef<NodeJS.Timeout | null>(null); // Ref to store timeout for focus reset
  ...
  return (
    <div className={`py-16 px-4 md:px-7 lg:p-20 bg-Rose100 w-full h-screen font-RedHat overflow-x-hidden select-none xl:p-[80px]`}>
      <>
        <h1 className="font-bold text-4xl text-Rose900 fixed bg-inherit inset-x-0 z-50 top-0 p-4 py-7 md:top-[unset] md:left-[unset] md:right-[unset] md:p-0 md:relative md:w-max">Desserts</h1>
            ...
            <div className="flex flex-col">
              ...
              {cart.length === 0 ? (
                <div className="py-8 lg:py-5">
                  ...
                  <p className="text-center font-medium text-Rose500 text-base lg:text-[12px] lg:pt-2">Your added items will appear here</p>
                </div>
              ) : (
                <div className="pt-3 lg:pt-2">
                  ...
                  <div className='text-base flex items-center gap-2 w-full px-4 mt-5 bg-Rose100 py-3 rounded-md md:justify-center lg:mt-4 lg:p-2 lg:text-[12px]'>
                  ...
                  <button
                    ...
                    type='submit'
                    className='w-full bg-Red mt-6 py-3 rounded-full font-semibold text-Rose100 text-base md:text-lg lg:text-base lg:py-2'
        ...
        <div className={`${toggleConfirmOrder ? 'block' : 'hidden'} absolute inset-0 h-screen overflow-hidden bg-Rose900/50 z-50`}>
          <div className=''>
            {isLoading || closeLoading ? (
              ...
              <div className={`${toggleConfirmOrder && 'animate-slideUp'} bg-Rose50 rounded-t-xl absolute bottom-28 right-0 left-0 top-[100px] h-full px-5 lg:p-[20px] md:h-max md:inset-x-20 md:inset-y-[150px] md:rounded-xl md:p-8 lg:h-[444px] lg:w-[400px] lg:inset-[0] lg:m-auto`}>
                <div className=''>
                  <div className='pt-6 pb-4 lg:p-0'>
                    <img
                      src={confirmIcon}
                      alt="order-complete-icon"
                      className='size-auto lg:size-8'
                    />
                  </div>
                  <h2 className='text-3xl w-[200px] md:w-full leading-tight font-bold lg:text-[24px] lg:pt-4'>Order Confirmed</h2>
                  <p className='text-base ssm:pt-3 ssm:pb-2 pt-2 pb-0 text-Rose500 lg:text-[12px] lg:leading-none'>We hope you enjoy your food!</p>
                </div>
                <div className='pb-10 pt-4'>
                  <div className='flex flex-col ssm:h-[298px] sm:h-[292px] md:h-[300px] lg:h-[237px] overflow-x-hidden '>
                    <div className='bg-Rose100 ssm:px-4 ssm:pt-1 sm:pt-0 ssm:pb-4 sm:px-4 lg:px-[15px] pt-2 pb-4 px-5 rounded-lg sm:h-[calc-size(auto)] ssm:h-[calc-size(auto)] mt-auto'>
                      {cart.map(item => (
                        <OrderConfirmed
                          key={item.id}
                          item={item}
                      ...
                      <p className='flex text-base lg:text-[14px] items-center font-semibold text-Rose900 pt-5 lg:pt-3'>Order Total
                        <span className='ml-auto text-2xl lg:text-lg font-bold'>
                          ${totalPrice}
                        </span>
                      </p>
                    </div>
